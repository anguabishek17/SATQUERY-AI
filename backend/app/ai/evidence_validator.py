...
def validate_reasoning(reasoning: str, evidence: EvidenceModel) -> dict:
    ...
    try:
        ...
        prompt = (
            ...
            "5. Grounding: Every reported numerical value, feature, and location must exist in Evidence JSON. No hallucinated objects or textbook filler.\n"
            "6. Missing evidence: If evidence is missing for a requested claim, state explicitly that available evidence is insufficient rather than guessing.\n"
            "7. Structure: If the reasoning uses the 5-part structure (Optical:, SAR:, Comparison:, Fusion insight:, Agreement/Confidence:), preserve that structure with double linebreaks.\n\n"
